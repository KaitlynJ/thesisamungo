...
## The Golden Age of Doctoring {.unnumbered}

### The man, the myth, the legend: understanding doctors of yesteryear {.unnumbered}

In 2006, the Millis report [@CITE], commisioned by the American Medical Association, was asked to review the current status of physicians in the US. In the first section, they recalled the coveted physician of memory in America:

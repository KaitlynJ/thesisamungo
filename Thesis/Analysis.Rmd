...
traditional$outcome <-ifelse((traditional$PRIMCARE == "Yes"), "TP", "T")
urgentcare$outcome <-ifelse((urgentcare$PRIMCARE == "Yes"), "UCP", "UC")
...
```{r make_them, echo=FALSE, cache= TRUE, warning=FALSE, message=FALSE}
library(nnet)

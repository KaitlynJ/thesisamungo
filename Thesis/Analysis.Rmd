...
traditional$outcome <-ifelse((traditional$PRIMCARE == "Yes"), "Traditional Primary", "Traditional")
urgentcare$outcome <-ifelse((urgentcare$PRIMCARE == "Yes"), "Urgent Care Primary", "Urgent Care")
...
```{r make_them, echo=FALSE, warning=FALSE, message=FALSE}
library(nnet)
...
\singlespacing
```{r logit_tables2, warning=FALSE, message=FALSE, echo=FALSE ,results="asis"}

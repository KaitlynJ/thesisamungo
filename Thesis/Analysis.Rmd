...
texreg(list(logit.beh, logit.dem, logit.full), 
       ...
       fontsize = "small", 
       custom.coef.names = c("Intercept", "Injury Related Visit", "Weekend Visit", "Established Patient", "Number Past Visits", "Visit Reason: Preventative", "Visit Reason: Routine/Chronic", "Age: Working", "Age: Retired", "Male", "Race: White", "High ZIP Income", "Rural"))

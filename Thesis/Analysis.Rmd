...
rticles::label(path = "figures/clusters.png", caption = "Identified patient typologies of urgent care centers visits (2008-2012).", 
      label = "clus1", type = "figure", scale = .35)
```
...
### Hypothesis: Urgent care centers as an extension of the wel-fare state {.unnumbered}

The premise of this hypothesis is that urgent care centers act much like emergency rooms: they are an option for the uninsured and poor, who, seeking medical attention, choose facilities where they will be treated regardless of their insurance status for acute/ non-routine care. 

...
\begin{document}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \CommentTok{# I think the most efficient way to connect them more clearly is to prioritize the parts of your theoretical/historical narrative that explain the actions of patients.}

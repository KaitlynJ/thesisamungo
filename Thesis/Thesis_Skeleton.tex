...
\begin{document}
  ...
  ** Need intro to this\ldots{} make more cohesive **
  ...
  in the US. Given these initial requirements, I thus chose the National
  ...
  health care trend in particular, the data set serves the purposes of the
  ...
  pros of performing an initial analysis of this nature are its ability to
  efficiently examine a large amount of variables and highlight those that
  should be included in the analysis. This was motivated by the current
  lack of statistical analysis and social theory surrounding urgent care
  centers, which makes it difficult to develop a model from scratch. The
  results of the clustering act as a guide for the regression techniques
  by identifying variables with some relationship to urgent care.
  ...
  NAMCS. While the combined years produced a data set of 123,123 (not

...
\usepackage{booktabs} \pagestyle{plain}
...
\begin{document}
  ...
  \addcontentsline{toc}{section}{National Trends in the Urgent Care
  Industry}
  ...
  \begin{figure}[h!]
  \centering
  \includegraphics[angle = 0,scale = 1]{figures/table.pdf}
  ...
  \addcontentsline{toc}{section}{The Changing Fate of Primary Care}
  ...
  \addcontentsline{toc}{subsection}{Examining Trends: Fact or fiction}
  ...
  \addcontentsline{toc}{subsection}{Why might patients not choose a
  traditioanl primary care practitioner?}
  ...
  \addcontentsline{toc}{section}{Testing Hypotheses}
  ...
  \addcontentsline{toc}{subsection}{Multinomial Logistic Regression
  Analysis}
  ...
  \addcontentsline{toc}{subsection}{Logistic Regression Analysis}
  ...
  \addcontentsline{toc}{subsubsection}{Hierarchal Clustering with

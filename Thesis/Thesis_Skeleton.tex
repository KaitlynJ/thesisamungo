...
\begin{document}
  ...
  ** Need intro to this\ldots{} make more cohesive **
  ...
  \addcontentsline{toc}{subsection}{The end of Medical Professional
  Dominance in the US?}
  ...
  \addcontentsline{toc}{section}{Urgent Care Centers as an extension of
  the Welfare State}
  ...
  \addcontentsline{toc}{section}{Urgent Care Centers as a New Model of
  Primary Care}
  ...
  \addcontentsline{toc}{section}{Urgent Care Centers: Emergency Rooms for
  the Wealthy?}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \NormalTok{h1<-}\StringTok{ }\KeywordTok{hoslem.test}\NormalTok{(dummiesUC.df$PRIMCAREYes, }\KeywordTok{fitted}\NormalTok{(logit2.full, }\DataTypeTok{g =}\DecValTok{10}\NormalTok{))}
  \NormalTok{h1}
  \end{Highlighting}
  \end{Shaded}
  ...
  Attaching package: 'rticles'
  \end{verbatim}
  
  \begin{verbatim}
  The following objects are masked from 'package:reedtemplates':
  
      label, reed_thesis, ref
  \end{verbatim}

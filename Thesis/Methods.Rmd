...
The following is a description of each variables used in the logistic model, which attempts to examine their effect on the decision to use an urgent care center as the patient's primary care physician. Most of the independant variables used in the logistic regression were recoded as binary categorical variables, and the etails of this recoding is discussed for each below.

***Injury Related Visit:*** Recoded as a dummy variable, where a 1 indicates that the visit was coded as being injury related and 0 meaning it was not.

***Weekend Visit*** A recoded dummy variable, where 1 indicates the visit occured on a saturday or a sunday.

***Established Patient***  A categorical variable recoded as 1 = 'Yes, established patient" and 0 indicating either "No, new patient" or "Unknown".
...
***Age*** Age was recoded into the variables that were 
